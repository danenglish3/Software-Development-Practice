    ...
    connection.query(queryProfile, (err, results, fields) => {
        ...
        connection.query(queryAccount, (err2, results2, fields2) => {
            ...
            connection.query(queryPhoto, (err3, results3, fields3) => {
                ...
                connection.query(queryServices, (err4, results4, fields4) => {
                    let filename;
                    if (results3[0] == null) {
                        filename = 'no_img.png';
                    } else {
                        ...
                        results4.forEach((service) => { // For each service found in the previous function
                            ...
                            connection.query(queryPhotos, (err5, results5) => {
                                ...
                                results5.forEach((element) => { // For each result of the photo query (results3):
                                    ...
                                    // Write the file to the temp directory
                                    fs.writeFile(`app/public/temp/${imgFilename}`, element.Photo_Blob, (err5) => {
                                        if (err5) throw err5;
                                    });
                                });
...
router.post('/edit_profile', (req, res) => {
    if (req.body.profileDelete === 'on') {
        ...
        connection.query(deleteAccount, (err, results, fields) => {
            if (err) throw err;
